# benny-safety Specification

## Purpose

Keep Benny source coordinates immutable and prevent delegated workers from posting or receiving Slack credentials.
...
- **THEN** grok `benny-triage` / `benny-repro` skills require freeze from the permalink
