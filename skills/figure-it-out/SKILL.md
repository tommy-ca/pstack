---
name: figure-it-out
description: "Design an auditable playbook when no narrower one fits: a large migration, an ambitious multi-part change, or work a human reviews after stepping away. Scales rigor to the task, runs a hypothesis loop, and logs decisions via show-me-your-work. Use for /figure-it-out, 'figure it out', upstream Cursor pstack refresh, sync-from-upstream, overlay port, host-adapter migration across many skills, a large migration, or when no narrower playbook applies."
