...
Transcripts live where this session's system prompt says they live. Do not hardcode `~/.cursor/projects/...`. Do not glob across other workspaces. Every line is one chat message.
