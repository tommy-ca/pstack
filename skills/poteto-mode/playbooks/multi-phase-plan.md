...
- [ ] On her go, persist the plan path on disk with this exact text. "<The plan path, the PR ids in order, the verification rule, who merges, and the done condition.>"
...
- [ ] Record a 30 to 60 second video of the change on the worktree child's real surface. Save it as `<media path>/<pr-id>-review.mp4`.
