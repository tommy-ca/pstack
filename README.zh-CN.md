...
| [`/verify-pstack`](./.grok/skills/verify-pstack/SKILL.md) | prove this plugin checkout. leftover scanner is required doctor. drives leftover-scanner, upstream-pin, upstream-recipe, refresh-hygiene, and release-tag through `.grok/skills/verify-pstack/scripts/verify.py`. |
