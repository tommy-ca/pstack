---
name: hardest-tasks
description: pstack hardest-tasks writer. Same posture as the pstack role of this name. Shipped effort is frontmatter `effort`. Setup may overlay via ~/.grok/roles/pstack:hardest-tasks.toml.
effort: xhigh
---
